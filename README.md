...
1. [ALZHEIMER'S DISEASE (AD)](#ALZHEIMER'S-DISEASE-(AD))
2. [GWAS ANALYSIS](#GWAS-ANALYSIS)
3. [TRANSCRIPTOME ANALYSIS](#TRANSCRIPTOME-ANALYSIS)
4. [AHB EXPRESSION ANALYSIS](#AHB-EXPRESSION-ANALYSIS)
5. [MRI ANALYSIS](#MRI-ANALYSIS)
...
<div align="center">
 Figure 1. Manhattanplot. The X-axis shows genes found on each chromosome, and the Y-axis shows the log of the  P-value. All the genes above the significance threshold line are correlated with AD.
</div> 
